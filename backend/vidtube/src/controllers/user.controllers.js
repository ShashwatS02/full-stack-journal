...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // 3. Get local file paths from multer
  ...
  // 5. Check for successful upload responses
  if (!avatar) {
    // If avatar upload fails, we can't proceed.
  ...
  if (!createdUser) {
    // If DB save fails, handle cleanup
    ...
    throw new ApiError(500, "User creation failed on database save");
  }
